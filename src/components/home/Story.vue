<template>
  ...
  <p>
    This website exists to document my journey, 
    to give me a place to share technical insights and other non-technical topics. 
    I’m settled and happy in my current role and not pursuing new employment, 
    but I value meaningful conversations and occasional collaboration.
  </p>

  <p>
    When I step away from the keyboard, 
    I’m curious about the world beyond my hometown, 
    different landscapes, and cultures. So travel posts are to be expected on my <a href="/blog">blog</a>.
  </p>
</template>

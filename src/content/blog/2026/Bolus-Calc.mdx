...
In early 2021, almost three years after I first built Bolus Calculator, an app user emailed me. Knowing something that I had created had made a difference to their daily life was incredibly rewarding, and it still is.

The following email exchange has been anonymised and **lightly** paraphrased to protect the user's privacy. Only the user's messages have been paraphrased; my responses remain unchanged, apart from identifying details. The original, unedited correspondence may be made available upon request, subject to obtaining the user's explicit consent.
...
<EmailThread emails={[
  ...
  Thank you for creating the app. It has made my daily life much easier, and I really appreciate it.
...
Adam`,
  },
  {
    ...
    SenderName: 'User X',
    Date: '2021-01',
    Body: `I can't think of any improvements. The app seems more accurate than others I've used, and it has already been incredibly helpful.`,
  },
  {
    SenderAddress: '***************@gmail.com',
    SenderName: 'Adam',
